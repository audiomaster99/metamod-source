...
target_compile_options(${LOADER_PROJECT_NAME} PRIVATE ${COMPILER_OPTIONS} ${SOURCESDK_COMPILE_OPTIONS})
target_link_options(${LOADER_PROJECT_NAME} PRIVATE ${LINK_OPTIONS} ${SOURCESDK_LINK_OPTIONS})

target_compile_definitions(${LOADER_PROJECT_NAME} PRIVATE ${COMPILE_DEFINITIONS} ${METAMOD_LOADER_COMPILE_DEFINITIONS} ${SOURCESDK_COMPILE_DEFINITIONS})
target_include_directories(${LOADER_PROJECT_NAME} PRIVATE ${METAMOD_LOADER_INCLUDE_DIRS} ${SOURCESDK_INCLUDE_DIRS})
